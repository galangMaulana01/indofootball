...
const renderOverview = () => {
  ...
  const renderLineups = () => {
    ...
    return (
      <View className="mb-8">
        <Text className="text-xs font-bold text-white uppercase tracking-wider pb-3 text-center mb-1">Starting Elevent</Text>
          ...
          {loading || !matchData ? (
            ...
            <View className="flex-row items-center justify-between px-2">
              ...
              <View className="items-center w-[30%]">
                ...
                <Text className="text-[10px] font-bold text-gray-200 tracking-wide uppercase">{matchData.statusLabel}</Text>
              </View>
              <View className="items-center w-[35%]">
